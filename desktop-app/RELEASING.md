...
Push `desktop-v4.0.4` or dispatch the Desktop Release workflow with that tag. Production builds intentionally fail unless the Ed25519 manifest key and public release token are present.
